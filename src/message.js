	...
	try {
		...
		if (welcome) {
			...
			for (let n of participants) {
                ...
                xeonbody = `
    ╶⃝Greetings    @${xeonName.split("@")[0]}♱
     ╶⃝your id numb ${xmembers}th♱`
...
await XeonBotInc.relayMessage(id, msgs.message, {})
	            ...
	            const xeonmembers = metadata.participants.length
					xeonbody = `┌─
    ╶⃝farewell.  @${xeonName.split("@")[0]}♱
    ╶⃝his id numb ${xeonmembers}th♱`
let msgs = generateWAMessageFromContent(id, {
  viewOnceMessage: {
    message: {
        "messageContextInfo": {
...
const xeondate = moment.tz('Asia/Kolkata').locale('en-IN').format('DD/MM/YYYY');
let xeonName = n
xeonbody = `@${xeonName.split("@")[0]},step forward you have been given the opportunity as sir *admin*`
...
const xeondate = moment.tz('Asia/Kolkata').locale('en-IN').format('DD/MM/YYYY');
let xeonName = n
xeonbody = `@${xeonName.split("@")[0]},step forward you have been removed as sir *admin*, please clear your desk`
await XeonBotInc.sendMessage(id,
 { text: xeonbody,
 contextInfo:{
 mentionedJid:[n],
